...
migrate((app) => {
    ...
    function createUser(data) {
        ...
        if (data.city) r.set("city", data.city);
        if (data.country) r.set("country", data.country);
    ...
    function createBusiness(ownerId, data) {
        ...
        r.set("city", data.city);
        r.set("country", data.country);
    ...
    // --- demo businesses ---
    let listings = [
        { name: "Bella Vista Trattoria", category: "restaurant", investmentType: "growth", location: "Lisbon, Portugal", city: "Lisbon", country: "Portugal",
        ...
        { name: "Sharp & Co. Barbershop", category: "barber", investmentType: "loan", location: "Porto, Portugal", city: "Porto", country: "Portugal",
        ...
        { name: "Iron Temple Gym", category: "gym", investmentType: "seed", location: "Madrid, Spain", city: "Madrid", country: "Spain",
        ...
        { name: "Morning Glory Café", category: "cafe", investmentType: "revenue_share", location: "Lisbon, Portugal", city: "Lisbon", country: "Portugal",
        ...
        { name: "Bloom & Co.", category: "retail", investmentType: "equity", location: "Barcelona, Spain", city: "Barcelona", country: "Spain",
        ...
        { name: "Crust Artisan Bakery", category: "bakery", investmentType: "convertible_note", location: "Lisbon, Portugal", city: "Lisbon", country: "Portugal",
