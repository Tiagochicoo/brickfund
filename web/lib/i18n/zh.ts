...
export const zh: TranslationDict = {
  ...
  auth: {
    ...
    citySelectFromList: "请从列表中选择城市。",
    cityNoMatches: "没有匹配的城市。",
    investorType: "投资者类型",
  ...
  listing: {
    ...
    images: "照片",
    imagesHint: "最多 6 张照片。第一张为封面。",
    imagesAdd: "添加照片",
    imagesRemove: "移除",
    imagesMax: "最多 {n} 张照片。",
    imagesType: "请选择图片文件。",
    imagesSize: "每张不超过 5 MB。",
    investmentTypeHint: "选择最匹配的结构。点击卡片查看说明。",
    cityRequired: "请从列表中选择城市。",
